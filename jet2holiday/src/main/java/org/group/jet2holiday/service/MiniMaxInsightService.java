...
@Service
public class MiniMaxInsightService {

    private final DashboardService dashboardService;
    private final MiniMaxClient miniMaxClient;

    public MiniMaxInsightService(DashboardService dashboardService, MiniMaxClient miniMaxClient) {
        this.dashboardService = dashboardService;
        this.miniMaxClient = miniMaxClient;
    }

    public PortfolioInsightResponse generateMiniMaxInsight(String range) {
        ...
        try {
            String insight = safeText(miniMaxClient.generateInsight(prompt));
            if (!insight.isBlank()) {
            ...
            // Fallback to deterministic summary when MiniMax fails.
        }
    ...
    private String buildPrompt(DashboardSummaryResponse summary, PerformanceResponse performance, String range) {
        ...
        return """
                Generate an English portfolio insight in 5-7 short bullet points.
                Required topics:
                - concentration risk
                - top contributors
    ...
    private String buildFallbackSummary(DashboardSummaryResponse summary, PerformanceResponse performance, String range) {
        ...
        return String.join("\n",
                ...
                "- Cash buffer stands at " + fmt(summary.getCashBalance()) + ", providing liquidity flexibility.",
                "- Recent performance (" + range + "): " + performanceLine + ".",
                "- Suggested action: reduce concentration and rebalance gradually into diversified exposures."
        );
    }
